...
Function Start-JCDashboard
{
    ...
    DynamicParam
    {
        ...
        If ($Layout -eq "singleComponent" -or $Layout -eq "gridView")
        {
            ...
            $attrColl.Add($attr)
            $attrColl.Add((New-Object System.Management.Automation.ValidateSetAttribute("system_agentVersion", "system_lastContact", "system_newSystems", "system_os", "system_version", "system_mfaStatus", "user_mfaStatus", "user_newUsers", "user_passwordChanges", "user_passwordExpirations", "user_privilegedUsers", "user_userStates", "onboarding_o365", "onboarding_ldap", "onbaording_gsuite", "onboarding_radius", "onboarding_useractivationstatus", "onboarding_systemuserassociations")))
            ...
            $attr1Coll.Add($attr1)
            $attr1Coll.Add((New-Object System.Management.Automation.ValidateSetattribute("system_agentVersion", "system_lastContact", "system_newSystems", "system_os", "system_version", "system_mfaStatus", "user_mfaStatus", "user_newUsers", "user_passwordChanges", "user_passwordExpirations", "user_privilegedUsers", "user_userStates", "onboarding_o365", "onboarding_ldap", "onbaording_gsuite", "onboarding_radius", "onboarding_useractivationstatus", "onboarding_systemuserassociations")))
