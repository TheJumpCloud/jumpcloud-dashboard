function UDElement-associations_userActivationStatus ()
{
    param (
        $refreshInterval,
        $lastContactDays,
    ...
    New-UDElement -Tag "associations_useractivationstatus" -Id "associations_useractivationstatus"  -RefreshInterval $refreshInterval -AutoRefresh -Content {
