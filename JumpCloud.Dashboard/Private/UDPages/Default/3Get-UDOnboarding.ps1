Function 3Get-UDOnboarding() {
    ...
    $UDPage = New-UDPage -Name:($PageName) -Content {
        ...
        $PageLayout = '{"lg":[{"w":5,"h":14,"x":0,"y":0,"i":"grid-element-onboarding_0365status","moved":false,"static":false},{"w":5,"h":14,"x":5,"y":0,"i":"grid-element-useractivationstatus","moved":false,"static":false}]}'
        $unDrawColor = "#006cac"
