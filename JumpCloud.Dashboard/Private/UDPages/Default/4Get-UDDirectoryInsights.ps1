Function 4Get-UDDirectoryInsights() {
    ...
    $UDPage = New-UDPage -Name:($PageName) -Content {
        ...
        $PageLayout = '{"lg":[{"w":4,"h":10,"x":0,"y":5,"i":"grid-element-directoryinsights_count"},{"w":4,"h":10,"x":4,"y":5,"i":"grid-element-directoryinsights_userCreateDelete"},{"w":4,"h":10,"x":9,"y":5,"i":"grid-element-system_<ID>"},{"w":4,"h":10,"x":0,"y":15,"i":"grid-element-<ID>"},{"w":4,"h":10,"x":4,"y":15,"i":"grid-element-<ID>"},{"w":4,"h":10,"x":9,"y":15,"i":"grid-element-<ID>"}]}'
        $unDrawColor = "#006cac"
